        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-gray-400 mb-6">
              SofiaTrades was founded on a simple principle: to provide intelligent, accessible, and transparent investment solutions. We bridge the gap between retail investors and institutional-grade fund management, leveraging a powerful synergy of seasoned financial experts and proprietary AI technology.
            </p>
          ...
          <div className="bg-dark-secondary rounded-xl p-8 border border-gray-700/50 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <div className="grid grid-cols-2 gap-8 mb-8 pb-8 border-b border-gray-700/50">
                ...
                <StatCard value="$500K+" label="Assets Managed" />
