...
const TestimonialsSection: React.FC = () => {
  const testimonials = [
    {
      quote: "The analytics on SofiaTrades are a game-changer. I'm making more informed decisions, and my profitability has increased by over 20% since I switched.",
      name: 'Kenji Tanaka',
      title: 'Full-Time Trader, Tokyo',
      avatar: 'https://picsum.photos/id/1005/100/100',
    },
    {
      quote: "As a beginner, I was intimidated by forex. SofiaTrades' platform is intuitive, and their support team has been incredibly helpful. I feel confident growing my portfolio here.",
      name: 'Sarah Jenkins',
      title: 'Part-Time Investor, London',
      avatar: 'https://picsum.photos/id/1027/100/100',
    },
    {
      quote: "Execution speed is everything. The low latency at SofiaTrades is unmatched. I've seen a significant reduction in slippage on my high-frequency trades.",
      name: 'Carlos Gomez',
    ...
    <section id="testimonials" className="py-20 md:py-28 bg-dark-primary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">Discover why thousands of traders choose SofiaTrades as their trusted partner.</p>
        </div>
